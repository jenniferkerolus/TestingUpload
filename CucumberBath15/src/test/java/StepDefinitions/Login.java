...
public class Login extends CommenMethods {
    ...
    public void users_enters_valid_email_and_valid_password() {
    ...
    @When("users enters valid {string} and valid {string}")
    public void users_enters_valid_and_valid(String username, String password) {
        LoginPage login = new LoginPage();
